...
def analyze_data_2():
    # Consulta todos los datos de la última hora, los agrupa por estación y variable
    # Compara el promedio con el valor maximo
    # Si el promedio se excede el valor maximo, se envia un mensaje de alerta.
...
def start_cron():
    ...
    print("Iniciando cron...")
    schedule.every(5).minutes.do(analyze_data_2)
